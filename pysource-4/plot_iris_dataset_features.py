#########################################################################
## module: plot_iris_dataset_features.py
## description: plotting features of the sklearn iris dataset covered in
## Ch. 2, Richert & Coeho. “Building ML Systems with Py.”
##
## to run:
## $ python plot_iris_dataset.py fig.png
##
...
## comment out when in IDLE
## there may be some FutureWarning when you run from command line;
## this can be ignored.
